...
# Based On The OneUpdater workflow, but heavily simplified for github releases, made by Alfred-emoji workflow
# refer to https://github.com/jsumners/alfred-emoji
# refer to https://github.com/vitorgalvao/alfred-workflows/tree/master/OneUpdater
readonly github_repo='Nauxscript/alfred-wechat-stickers'
