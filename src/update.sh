...
readonly remote_info_plist='https://github.com/Nauxscript/alfred-wechat-stickers/blob/main/src/info.plist'
readonly workflow_url='Nauxscript/alfred-wechat-stickers'
